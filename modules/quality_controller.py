...
class QualityController:
    ...
    def check_required_info(
        self, narrative: str, format: str = "presoaped_format"
    ) -> str:
        """
        ...
        narrative_with_missing_info = self.integrate_missing_information(
            narrative, missing_elements
        )

        return narrative_with_missing_info

    def integrate_missing_information(
        self, narrative: str, missing_elements: str
    ) -> str:
        """
