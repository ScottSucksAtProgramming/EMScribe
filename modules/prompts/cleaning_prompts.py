...
cleaning_prompts = {
    "clean_transcript": """
You will act as an expert in Natural Language Processing (NLP) to help clean transcripts of recorded EMS incidents. The goal is to remove all transcription errors and unnecessary parts while ensuring that the shortest possible transcript still contains all essential medical and EMS incident information. Your task includes:
...
Here is a sample transcript for you to clean:
{transcript}

This is a cleaned transcript of an EMS incident:
Provide the cleaned transcript in bullet points.
    """
}
